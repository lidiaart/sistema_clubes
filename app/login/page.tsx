...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4 py-12">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.18),_transparent_24%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.16),_transparent_24%)]" />
      <div className="relative w-full max-w-md rounded-[32px] border border-white/10 bg-slate-900/90 p-8 shadow-2xl backdrop-blur-sm">
        <div className="mb-8">
          <p className="text-sm uppercase tracking-[0.3em] text-cyan-300">Acesso seguro</p>
          <h1 className="mt-3 text-3xl font-semibold text-white">Entrar na sua conta</h1>
          <p className="mt-3 text-sm text-slate-400">Gestione clubes, eventos e sua participação com uma interface moderna.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          Ainda não tem conta?{' '}
          <Link href="/register" className="font-semibold text-white hover:text-cyan-200">
            Cadastre-se aqui
          </Link>
          .
        </p>
